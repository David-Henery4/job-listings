...
const JobsFilterTags = () => {
  return (
    <div className="bg-[#ffffff] w-full max-w-96 mx-auto p-6 rounded-md flex justify-start items-center shadow-2xl shadow-desaturatedDarkCyan/30 gap-3 -mt-[68px] relative tab:-mt-[82px] tab:max-w-[1110px]">
